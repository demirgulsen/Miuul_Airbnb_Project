...
def get_top_superhosts(df, top_n=10):
    ...
    return top_superhosts[['host_url', 'host_name','listing_url', 'years_as_host','host_picture_url','host_about', 'number_of_reviews', 'review_scores_rating']]
...
def main():
    ...
    listing = listing[['id', 'price', 'name', 'host_id', 'host_url', 'listing_url','host_about','host_picture_url', 'host_name', 'host_since',
